...
još s Dependency i No High School Diploma dobili smo najbolji model.

```{r}
fit2 <- lm(povertyDataset$Assault..Homicide.~povertyDataset$Unemployment +
             povertyDataset$No.High.School.Diploma + povertyDataset$Dependency)
summary(fit2)
```

Najbolje rezultate bez korištenja varijable nezaposlenosti dobivamo sa dolje
modelom. Koristeći crowded housing nećemo dobiti bolji model jer već No High
School Diploma opisuje taj efekt nad podacima.

```{r}
fit3 <- lm(povertyDataset$Assault..Homicide.~ povertyDataset$Dependency + 
              povertyDataset$No.High.School.Diploma+povertyDataset$Below.Poverty.Level 
