...
##Korelacija među zločinima i socio ekonomskih faktorima

```{r}
kable(table(povertyDataset$Below.Poverty.Level, povertyDataset$Assault..Homicide.))
povertyDataset$per
...
cat("\n")
```
Očito je da je učestalost krađa oko 7 puta veća od učestalosti kriminala vezanih za narkotike.